              	...
              	<div class="sidebar-content">
                	<div class="sidebar-header">
	                  	<div class="sidebar-details">
	                    	<h5 class="m-0 sidebar-title"><i class="material-icons app-header-icon text-top">perm_identity</i> Contacts</h5>
                  ...
                  <table id="data-table-contact" class="display" style="width:100%">
                    ...
                    <tbody>
                       <tr v-for="mark in marks">
                        ...
                        <td><span class="avatar-contact avatar-online"><img v-bind:src="mark.logo"></span></td>
                        <td>{{mark.nombre}}</td>
                        <td>{{mark.pagina}}</td>
                        <td>{{mark.direccion}}</td>
                        <td>{{mark.telefono}}</td>
